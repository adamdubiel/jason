...
/**
 * Adapts a Jason 1.x tree-style adapter as a streaming TypeAdapter. Since the
...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
  ...
  private TreeTypeAdapter(JsonSerializer<T> serializer, JsonDeserializer<T> deserializer,
      Jason gson, TypeToken<T> typeToken, TypeAdapterFactory skipPast) {
  ...
  /**
   * Returns a new factory that will match each type against {@literal exactType}.
   */
