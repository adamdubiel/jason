...
import org.jasonjson.core.internal.JsonReaderInternalAccess;
 ...
 * form encodes reasonably: <pre>   {@literal Map<Point, String> original = new LinkedHashMap<Point, String>();
...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
   ...
   */
  private TypeAdapter<?> getKeyAdapter(Jason context, Type keyType) {
  ...
  private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
    ...
    public Adapter(Jason context, Type keyType, TypeAdapter<K> keyTypeAdapter,
