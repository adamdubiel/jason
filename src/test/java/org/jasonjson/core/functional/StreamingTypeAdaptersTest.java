...
public final class StreamingTypeAdaptersTest extends TestCase {
  private Jason miniGson = new JasonBuilder().create();
  ...
  private void usePersonNameAdapter() {
    ...
    miniGson = new JasonBuilder().registerTypeAdapter(Person.class, personNameAdapter).create();
  ...
  public void testNullSafe() {
    ...
    gson = new JasonBuilder().registerTypeAdapter(Person.class, typeAdapter.nullSafe()).create();
