...
public class PrimitiveTest extends TestCase {
  ...
  public void testDoubleNaNSerialization() {
    Jason gson = new JasonBuilder().serializeSpecialFloatingPointValues().create();
    double nan = Double.NaN;
  ...
  public void testLongAsStringSerialization() throws Exception {
    gson = new JasonBuilder().setLongSerializationPolicy(LongSerializationPolicy.STRING).create();
  ...
  public void testHtmlCharacterSerialization() throws Exception {
    ...
    gson = new JasonBuilder().disableHtmlEscaping().create();
