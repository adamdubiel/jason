...
import org.jasonjson.core.ParameterizedTypeFixtures.MyParameterizedType;
import org.jasonjson.core.ParameterizedTypeFixtures.MyParameterizedTypeAdapter;
import org.jasonjson.core.ParameterizedTypeFixtures.MyParameterizedTypeInstanceCreator;
...
/**
 * Functional tests for the serialization and deserialization of parameterized types in Jason.
 *
...
public class ParameterizedTypesTest extends TestCase {
   ...
   *
   * @param <>> Enforce T to be a string to make writing the "toExpectedJson" method easier.
   */
