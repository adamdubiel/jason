...
/**
 * Tests for Jason serialization of a sub-class object while encountering a base-class type
 *
...
public class MoreSpecificTypeSerializationTest extends TestCase {
  ...
  /**
   * For parameterized type, Jason ignores the more-specific type and sticks to the declared type
   */
  ...
  /**
   * For parameterized type in a List, Jason ignores the more-specific type and sticks to
 the declared type
   */
  ...
  /**
   * For parameterized type in a map, Jason ignores the more-specific type and sticks to the
 declared type
   */
