...
public class CustomDeserializerTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    super.setUp();
    gson = new JasonBuilder().registerTypeAdapter(DataHolder.class, new DataHolderDeserializer()).create();
  }
  ...
  public void testJsonTypeFieldBasedDeserialization() {
    ...
    Jason gson = new JasonBuilder().registerTypeAdapter(MyBase.class, new JsonDeserializer<MyBase>() {
