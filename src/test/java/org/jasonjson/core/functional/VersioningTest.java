...
/**
 * Functional tests for versioning support in Jason.
 *
...
public class VersioningTest extends TestCase {
  ...
  public void testVersionedUntilSerialization() {
    ...
    Jason gson = builder.setVersion(1.29).create();
  ...
  public void testVersionedUntilDeserialization() {
    Jason gson = builder.setVersion(1.3).create();
  ...
  public void testVersionedClassesSerialization() {
    Jason gson = builder.setVersion(1.0).create();
  ...
  public void testIgnoreLaterVersionClassDeserialization() {
    ...
    // This is the new behavior in Jason 2.0
