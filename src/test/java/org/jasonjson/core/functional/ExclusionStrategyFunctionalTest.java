...
/**
 * Performs some functional tests when Jason is instantiated with some common user defined
...
public class ExclusionStrategyFunctionalTest extends TestCase {
  ...
  public void testExclusionStrategySerialization() throws Exception {
    Jason gson = createGson(new MyExclusionStrategy(String.class), true);
  ...
  public void testExclusionStrategyDeserialization() throws Exception {
    Jason gson = createGson(new MyExclusionStrategy(String.class), false);
  ...
  private static Jason createGson(ExclusionStrategy exclusionStrategy, boolean serialization) {
    JasonBuilder gsonBuilder = new JasonBuilder();
    if (serialization) {
