...
/**
 * Tests to measure performance for Jason. All tests in this file will be disabled in code. To run
...
public class PerformanceTest extends TestCase {
   ...
   * Created in response to http://code.google.com/p/google-gson/issues/detail?id=96
   */
  // Last I tested, Jason was able to serialize upto 14MB byte array
   ...
   * Created in response to http://code.google.com/p/google-gson/issues/detail?id=96
   */
  // Last I tested, Jason was able to deserialize a byte array of 11MB
...
// The tests to measure serialization and deserialization performance of Jason
